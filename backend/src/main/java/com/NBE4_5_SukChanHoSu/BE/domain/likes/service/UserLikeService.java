        ...
        if (!keys.isEmpty()) {
            for (String key : keys) {
                ...
                if (value instanceof Map) {
                    ...
                    try {
                        UserLikes like = objectMapper.convertValue(map, new TypeReference<UserLikes>() {
                        });
                        ...
                        throw new RedisSerializationException("500", "JSON 역직렬화 실패1" + e);
                    }
                }
            }
        } else {
            ...
            for (String key : keys) {
                ...
                if (value instanceof Map) {
                    ...
                    try {
                        ...
                        throw new RedisSerializationException("500", "JSON 역직렬화 실패2" + e);
                    }
                }
            }
        } else {
