...
public class UserProfileController {
    ...
    public RsData<ProfileResponseDto> createProfile(
    ...
    @PutMapping
    public RsData<ProfileResponseDto> updateProfile(
            @AuthenticationPrincipal Member actor,
    ...
    public RsData<NicknameCheckResponseDto> checkNickname(
            @Parameter(name = "nickname", description = "중복 검사할 닉네임") @RequestParam String nickname) {
